...
from .hslu_gui_methods import *
from .hou_buttons import *


class HoudiniList(QtWidgets.QListWidget):

    nodesDropped = QtCore.Signal(bytes)

    def __init__(self, parent=None):
        super(HoudiniList, self).__init__(parent)
...
class HoudiniDropListLayout(QtWidgets.QWidget):
    def __init__(self, node_path: str, uuid: str,parent=None ):
        super(HoudiniDropListLayout, self).__init__()
    ...
    def StyleSwitcher(self,base : str, cooked: str, rendered: str):
        ...
        if self.dlo_info.GetCookStatus():
            ...
            self.setStyleSheet(f"""QWidget#HoudiniDropListLayout {{ background-color: {base} }} """)
