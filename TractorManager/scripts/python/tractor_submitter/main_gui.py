...
from .hslu_db_methods import MethodsDB, ProjectInfoRetriever
from .hslu_gui_methods import BooleanMethods, DrawingMethods, DropListObjectInfo, GuiInfoMethods, StylingMethods
from .hslu_gui_objects import HoudiniList, HoudiniDropListLayout
from .hslu_houdini_methods import TopManagingMethods, ExportTypes
from .hslu_submission_methods import HoudiniSubmissionMethods
        ...
        if len(cook_locally.keys()) >= 1:   
            ...
            if top_job.CreateTopGraphAndCook():
                for uuid, node in cook_locally.items():
                    ...
                    StylingMethods.ChangeBgCol(self.DroppedWidgetList[uuid][0], self.CookedCd)
